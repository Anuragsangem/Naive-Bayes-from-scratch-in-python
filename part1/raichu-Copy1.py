...
def pichu_w(board2D, N ,player):
    ...
    for r, c in pichu_loc:
        ...
        if valid_index((r + 1, c - 1), N):
            ...
            elif valid_index((r + 2, c - 2), N) and board2D[r + 2][c - 2] == '.' and board2D[r + 1][c - 1] == 'b':
...
def pichu_b(board2D, N ,player):
    ...
    for r, c in pichu_loc:
        ...
        if valid_index((r - 1, c - 1), N):
            ...
            elif valid_index((r - 2, c - 2), N) and board2D[r - 2][c - 2] == '.' and board2D[r - 1][c - 1] == 'w':
    ...
    for r, c in pikachu_loc:
        ...
        if valid_index((r + 1, c), N):
            if board2D[r + 1][c] == '.':
                ...
                board_succ = copy.deepcopy(board2D)
                if valid_index((r + 2, c), N) and board2D[r + 2][c] == '.':
                    board_succ[r + 2][c] = 'W'
                    board_succ[r][c] = '.'
                    pikachu_succ.append(board_succ)
        ...
        if valid_index((r + 1, c), N) and (board2D[r + 1][c] == 'b' or board2D[r + 1][c] == 'B'):
                ...
                board_succ = copy.deepcopy(board2D)
                if valid_index((r + 2, c), N) and board2D[r + 2][c] == '.' and (valid_index((r + 3, c), N) and board2D[r + 3][c] == '.'):
                    board_succ[r + 3][c] = 'W'
                    board_succ[r + 2][c] = '.'
                    board_succ[r + 1][c] = '.'
                    board_succ[r][c] = '.'
    ...
    for r, c in pikachu_loc:
        ...
        if valid_index((r + 2, c), N) and (board2D[r + 2][c] == 'b' or board2D[r + 2][c] == 'B'):
                if valid_index((r + 1, c), N) and board2D[r + 1][c] == '.':
                    if valid_index((r + 3, c), N) and board2D[r + 3][c] == '.':
                        board_succ[r + 3][c] = 'W'
                        board_succ[r + 2][c] = '.'
                        board_succ[r + 1][c] = '.'
                        board_succ[r][c] = '.'
...
def raichu_B(board2D, N ,player):
    pichu_loc=[(row_i, col_i) for col_i in range(len(board2D[0])) for row_i in range(len(board2D)) if board2D[row_i][col_i]=="$"]
